    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            "                             dirty if they have previously been used in a transaction."},
                    {"custom_change_address", RPCArg::Type::STR, RPCArg::Optional::OMITTED_NAMED_ARG, "If no address is specified here the change will go to\n"
            "                             newly generated address in the wallet."},
                },
                RPCResult{
...
{ //  category              name                                actor (function)                argNames
    ...
    { "wallet",             "sendmany",                         &sendmany,                      {"dummy","amounts","minconf","comment","subtractfeefrom","replaceable","conf_target","estimate_mode", "custom_change_address"} },
    { "wallet",             "sendtoaddress",                    &sendtoaddress,                 {"address","amount","comment","comment_to","subtractfeefromamount","replaceable","conf_target","estimate_mode","avoid_reuse", "custom_change_address"} },
